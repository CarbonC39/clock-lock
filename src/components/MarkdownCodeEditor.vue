...
const mdHighlight = HighlightStyle.define([
  ...
  { tag: tags.heading3, color: "var(--color-accent-teal)", fontWeight: "600" },
  { tag: tags.heading4, color: "var(--color-accent-teal)", fontWeight: "600" },
  ...
  { tag: tags.list, color: "var(--color-accent-yellow)" },
  { tag: tags.quote, color: "var(--color-text-muted)", fontStyle: "italic" },
  { tag: tags.monospace, fontFamily: "var(--font-mono)", color: "var(--color-accent-blue)" },
